...
export type Routes = {
    admin: {
        ...
        reconciliationReports: typeof import("../src/api/admin/reconciliation-reports/route");
    };
    auth: {
        $actorType: {
    ...
    store: {
        ...
        customDesigns: typeof import("../src/api/store/custom-designs/route");
    ...
    webhooks: {
        productionStatus: typeof import("../src/api/webhooks/production-status/route");
    };
};
